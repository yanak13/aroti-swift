//
//  FullHoroscopeForecastView.swift
//  Aroti
//
//  Full horoscope forecast content view (sections 8.1-8.5)
//

import SwiftUI

struct FullHoroscopeForecastView: View {
        ...
        ZStack(alignment: .top) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    // Page Header
                    BaseHeader(
                        title: "\(currentMonthName) Horoscope Overview",
