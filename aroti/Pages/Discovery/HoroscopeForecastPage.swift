...
//  Aroti
//
//  Horoscope Forecast detail page (Premium users only)
//
    ...
    private var heroCardContent: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text("Your personalized horoscope forecast for \(currentMonthName) will appear here.")
                    .font(.system(size: 14))
                    .foregroundColor(DesignColors.mutedForeground)
                    .lineLimit(3)
                    .lineSpacing(4)
    ...
    private var howItsCreatedSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                numberedListItem(
                    number: 1,
                    title: "Your birth data and zodiac placements"
                )
                
                numberedListItem(
                    number: 2,
                    title: "Planetary movements for the selected month"
                )
                
                numberedListItem(
                    number: 3,
                    title: "Interpreted into clear, human guidance"
                )
            }
        }
    }
    ...
    private var forecastContentSection: some View {
        VStack(alignment: .leading, spacing: 24) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                Text("\(currentMonthName) Horoscope Overview")
